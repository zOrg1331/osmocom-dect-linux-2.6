...
enum dect_basic_cctrl_cmds {
	...
	DECT_BASIC_CCTRL_BEARER_HANDOVER_REQ	= 0x1ULL << DECT_MT_CMD_SHIFT,
	DECT_BASIC_CCTRL_CONNECTION_HANDOVER_REQ= 0x2ULL << DECT_MT_CMD_SHIFT,
...
enum dect_advanced_cctrl_cmds {
	DECT_ADV_CCTRL_ACCESS_REQ		= 0x0ULL << DECT_MT_CMD_SHIFT,
	DECT_ADV_CCTRL_BEARER_HANDOVER_REQ	= 0x1ULL << DECT_MT_CMD_SHIFT,
	DECT_ADV_CCTRL_CONNECTION_HANDOVER_REQ	= 0x2ULL << DECT_MT_CMD_SHIFT,
	DECT_ADV_CCTRL_UNCONFIRMED_ACCESS_REQ	= 0x3ULL << DECT_MT_CMD_SHIFT,
	DECT_ADV_CCTRL_BEARER_CONFIRM		= 0x4ULL << DECT_MT_CMD_SHIFT,
	DECT_ADV_CCTRL_WAIT			= 0x5ULL << DECT_MT_CMD_SHIFT,
	DECT_ADV_CCTRL_ATTRIBUTES_T_REQUEST	= 0x6ULL << DECT_MT_CMD_SHIFT,
	DECT_ADV_CCTRL_ATTRIBUTES_T_CONFIRM	= 0x7ULL << DECT_MT_CMD_SHIFT,
	DECT_ADV_CCTRL_BANDWIDTH_T_REQUEST	= 0x8ULL << DECT_MT_CMD_SHIFT,
	DECT_ADV_CCTRL_BANDWIDTH_T_CONFIRM	= 0x9ULL << DECT_MT_CMD_SHIFT,
	DECT_ADV_CCTRL_CHANNEL_LIST		= 0xaULL << DECT_MT_CMD_SHIFT,
	DECT_ADV_CCTRL_UNCONFIRMED_DUMMY	= 0xbULL << DECT_MT_CMD_SHIFT,
	DECT_ADV_CCTRL_UNCONFIRMED_HANDOVER	= 0xcULL << DECT_MT_CMD_SHIFT,
	DECT_ADV_CCTRL_RELEASE			= 0xfULL << DECT_MT_CMD_SHIFT,
};

#define DECT_ADV_CCTRL_ATTR_ECN_MASK		0x00f0000000000000ULL
#define DECT_ADV_CCTRL_ATTR_ECN_SHIFT		52

#define DECT_ADV_CCTRL_ATTR_LBN_MASK		0x000f000000000000ULL
#define DECT_ADV_CCTRL_ATTR_LBN_SHIFT		48

#define DECT_ADV_CCTRL_ATTR_TYPE_MASK		0x0000c00000000000ULL
#define DECT_ADV_CCTRL_ATTR_TYPE_SHIFT

#define DECT_ADV_CCTRL_ATTR_SERVICE_MASK	0x00003f0000000000ULL
#define DECT_ADV_CCTRL_ATTR_SERVICE_SHIFT

#define DECT_ADV_CCTRL_ATTR_SLOT_MASK		0x000000f000000000ULL
#define DECT_ADV_CCTRL_ATTR_SLOT_SHIFT

#define DECT_ADV_CCTRL_ATTR_CF_FLAG		0x0000000800000000ULL

#define DECT_ADV_CCTRL_ATTR_BZ_EXT_MOD_MASK	0x0000000700000000ULL
#define DECT_ADV_CCTRL_ATTR_BZ_EXT_MOD_SHIFT

#define DECT_ADV_CCTRL_ATTR_ACR_MASK		0x00000000f0000000ULL
#define DECT_ADV_CCTRL_ATTR_ACR_SHIFT

#define DECT_ADV_CCTRL_ATTR_A_MOD_MASK		0x000000000c000000ULL
#define DECT_ADV_CCTRL_ATTR_A_MOD_SHIFT

#define DECT_ADV_CCTRL_ATTR_BZ_MOD_MASK		0x0000000003000000ULL
#define DECT_ADV_CCTRL_ATTR_BZ_MOD_SHIFT
